...
age_counts %>% filter(gender==1|gender==2, age<100) %>% ggplot(aes(x = age, y = n, fill = as.factor(gender))) + geom_col() + labs(title = "Citi Bike Users By Age And Gender", x = "Age", y = "Count") + theme(plot.title = element_text(hjust = 0.5)) + scale_fill_discrete(name="Gender", labels = c("Male Identifying","Female Identifying"))
```
